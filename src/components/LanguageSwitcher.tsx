...
export const LanguageSwitcherMinimal = (props: Omit<LanguageSwitcherProps, 'variant'>) => (
  <LanguageSwitcher {...props} variant="minimal" />
);

export const LanguageSwitcherFull = (props: Omit<LanguageSwitcherProps, 'variant'>) => (
