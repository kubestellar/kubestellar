...
Check out our [QuickStart Guide](https://docs.kubestellar.io/{{ config.ks_branch }}/Getting-Started/quickstart/)
...
there is a larger example in https://docs.kubestellar.io/{{ config.ks_branch }}/Coding%20Milestones/PoC2023q1/example1/.
