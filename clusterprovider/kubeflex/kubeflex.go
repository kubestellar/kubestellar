...
// ListClusterNames: returns a list of clusters in KubeFlex that are
// in the Ready condition.
// TODO: switch from CLI to getting this info via kube directives
func (k KflexClusterProvider) ListClustersNames() ([]string, error) {
...
func (k KflexClusterProvider) Get(lcName string) (clusterprovider.LogicalClusterInfo, error) {
...
func (k KflexClusterProvider) ListClusters() ([]clusterprovider.LogicalClusterInfo, error) {
	logger := klog.Background()
	lcNames, _ := k.ListClustersNames()
