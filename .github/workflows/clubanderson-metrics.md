...
- **Help-wanted count**: Look for `"total_count":` at the start of `help-wanted-created.json`. Use ONLY that number. DO NOT count items. If you see `"total_count": 4`, the answer is 4.
- **Merged PRs count**: Look for `"total_count":` at the start of `prs-merged.json`. Use ONLY that number. DO NOT count items. If you see `"total_count": 26`, the answer is 26.
- **PR reviews count**: 
