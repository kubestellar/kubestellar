...
0. [Install Prerequisites](#1-check-and-install-prerequisites)
1. [Install and run **KubeStellar**](#2-install-and-run-kubestellar)
2. [Example deployment of Apache HTTP Server workload into two local kind clusters](#3-example-deployment-of-apache-http-server-workload-into-two-local-kind-clusters)
...
3. [Teardown the environment](#4-teardown-the-environment)
