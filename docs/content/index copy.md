...
<br/>
[![Generate and push docs]({{config.repo_url}}/actions/workflows/docs-gen-and-push.yml/badge.svg?branch={{ config.ks_branch }})]({{config.repo_url}}/actions/workflows/docs-gen-and-push.yml)&nbsp;&nbsp;&nbsp;
[![Broken Links Crawler]({{ config.repo_url }}/actions/workflows/broken-links-crawler.yml/badge.svg?branch={{ config.ks_branch }})]({{config.repo_url}}/actions/workflows/broken-links-crawler.yml)&nbsp;&nbsp;&nbsp;
