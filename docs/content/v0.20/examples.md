...
```shell
helm upgrade --install -n wds2-system kubestellar oci://ghcr.io/kubestellar/kubestellar/controller-manager-chart --version v0.20.0-alpha.1 --set ControlPlaneName=wds2 --set APIGroups=workload.codeflare.dev
```
