...
That command will print some notes about how to get kubeconfig "contexts" named "its1" and "wds1" define. Do that, because those contexts are used in the following.
