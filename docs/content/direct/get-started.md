...
For use with k3d
```shell
bash <(curl -s https://raw.githubusercontent.com/clubanderson/kubestellar/refs/heads/add-k3d-to-create-demo-env/scripts/create-kubestellar-demo-env.sh) --platform k3d
```
