...
3. Using `import-cp-contexts.sh` script
   ...
   - `--names|-n <name1>,<name2>,..` comma separated list of KubeFlex Control Planes names to import. If this argument is not specified then _all_ available KubeFlex Control Planes will be imported.
