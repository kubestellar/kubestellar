...
```shell
bash <(curl -s https://raw.githubusercontent.com/kubestellar/kubestellar/v0.23.0-rc1/scripts/create-kind-cluster-with-SSL-passthrough.sh) --name kubeflex --port 9443
```
...
```shell
bash <(curl -s https://raw.githubusercontent.com/kubestellar/kubestellar/v0.23.0-rc1/scripts/create-k3s-cluster-with-SSL-passthrough.sh) --port 9443
```
