...
For detailed information about each subproject's specific functionality, architecture, and usage, please refer to their respective repositories and the [Packaging and Delivery documentation](direct/packaging.md).
