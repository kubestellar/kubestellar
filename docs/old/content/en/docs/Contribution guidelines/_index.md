...
Check out our [Quickstart Guide](/docs/getting-started/quickstart/)
...
If you have any questions about contributing, don't hesitate to reach out to us on the KubeStellar-dev [Slack channel](https://kubernetes.slack.com/archives/C021U8WSAFK).

## Testing Locally
Check out our [quickstart guide](/docs/getting-started/quickstart/) to install a local KCP server and install the KubeStellar components
