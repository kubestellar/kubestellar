...
type customTransforms struct {
	*gentype.ClientWithList[*v1alpha1.CustomTransform, *v1alpha1.CustomTransformList]
}
...
func newCustomTransforms(c *ControlV1alpha1Client) *customTransforms {
	return &customTransforms{
		gentype.NewClientWithList[*v1alpha1.CustomTransform, *v1alpha1.CustomTransformList](
			"customtransforms",
			c.RESTClient(),
