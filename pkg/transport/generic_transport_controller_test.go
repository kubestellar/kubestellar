...
func TestGenericController(t *testing.T) {
	...
	ctlr := NewTransportControllerForWrappedObjectGVR(ctx, inventoryPreInformer, wdsKsClientFake.ControlV1alpha1().Bindings(), wdsKsInformerFactory.Control().V1alpha1().Bindings(), transport, wdsDynamicClient, itsDynamicClient, "test-wds", wrapperGVR)
