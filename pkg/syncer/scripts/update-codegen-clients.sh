...
bash "${CODEGEN_PKG}"/generate-groups.sh "deepcopy,client" \
  github.com/kcp-dev/edge-mc/pkg/syncer/client github.com/kcp-dev/edge-mc/pkg/syncer/apis \
  "edge:v1alpha1" \
  --go-header-file "${SCRIPT_ROOT}"/hack/boilerplate/boilerplate.generatego.txt \
  --output-base "${SCRIPT_ROOT}" \
  --trim-path-prefix github.com/kcp-dev/edge-mc

pushd ./pkg/syncer/apis
${CODE_GENERATOR} \
  "client:outputPackagePath=github.com/kcp-dev/edge-mc/pkg/syncer/client,apiPackagePath=github.com/kcp-dev/edge-mc/pkg/syncer/apis,singleClusterClientPackagePath=github.com/kcp-dev/edge-mc/pkg/syncer/client/clientset/versioned,headerFile=${BOILERPLATE_HEADER}" \
  "lister:apiPackagePath=github.com/kcp-dev/edge-mc/pkg/syncer/apis,headerFile=${BOILERPLATE_HEADER}" \
  "informer:outputPackagePath=github.com/kcp-dev/edge-mc/pkg/syncer/client,apiPackagePath=github.com/kcp-dev/edge-mc/pkg/syncer/apis,singleClusterClientPackagePath=github.com/kcp-dev/edge-mc/pkg/syncer/client/clientset/versioned,headerFile=${BOILERPLATE_HEADER}" \
  "paths=./..." \
  "output:dir=./../client"
popd
