...
import (
	...
	lcv1alpha1listers "github.com/kcp-dev/edge-mc/pkg/client/listers/lc/v1alpha1"
)
...
type LogicalClusterClusterInformer interface {
	...
	Lister() lcv1alpha1listers.LogicalClusterClusterLister
}
	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.LcV1alpha1().LogicalClusters().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LcV1alpha1().LogicalClusters().Watch(context.TODO(), options)
			},
		},
		&lcv1alpha1.LogicalCluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *logicalClusterClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return f.factory.InformerFor(&lcv1alpha1.LogicalCluster{}, f.defaultInformer)
}

func (f *logicalClusterClusterInformer) Lister() lcv1alpha1listers.LogicalClusterClusterLister {
	return lcv1alpha1listers.NewLogicalClusterClusterLister(f.Informer().GetIndexer())
}
...
type LogicalClusterInformer interface {
	...
	Lister() lcv1alpha1listers.LogicalClusterLister
}
...
func (f *logicalClusterInformer) Lister() lcv1alpha1listers.LogicalClusterLister {
	return f.lister
}
...
func (f *logicalClusterScopedInformer) Lister() lcv1alpha1listers.LogicalClusterLister {
	return lcv1alpha1listers.NewLogicalClusterLister(f.Informer().GetIndexer())
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.LcV1alpha1().LogicalClusters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LcV1alpha1().LogicalClusters(namespace).Watch(context.TODO(), options)
			},
		},
		&lcv1alpha1.LogicalCluster{},
		resyncPeriod,
