...
type EdgeSyncConfigClusterInformer interface {
	...
	Lister() edgev2alpha1listers.EdgeSyncConfigClusterLister
}
	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.EdgeV2alpha1().EdgeSyncConfigs().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EdgeV2alpha1().EdgeSyncConfigs().Watch(context.TODO(), options)
			},
		},
		&edgev2alpha1.EdgeSyncConfig{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *edgeSyncConfigClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return f.factory.InformerFor(&edgev2alpha1.EdgeSyncConfig{}, f.defaultInformer)
}

func (f *edgeSyncConfigClusterInformer) Lister() edgev2alpha1listers.EdgeSyncConfigClusterLister {
	return edgev2alpha1listers.NewEdgeSyncConfigClusterLister(f.Informer().GetIndexer())
}
...
type EdgeSyncConfigInformer interface {
	...
	Lister() edgev2alpha1listers.EdgeSyncConfigLister
}
...
func (f *edgeSyncConfigInformer) Lister() edgev2alpha1listers.EdgeSyncConfigLister {
	return f.lister
}
...
func (f *edgeSyncConfigScopedInformer) Lister() edgev2alpha1listers.EdgeSyncConfigLister {
	return edgev2alpha1listers.NewEdgeSyncConfigLister(f.Informer().GetIndexer())
}
