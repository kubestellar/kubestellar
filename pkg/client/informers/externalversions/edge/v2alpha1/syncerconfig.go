...
type SyncerConfigClusterInformer interface {
	...
	Lister() edgev2alpha1listers.SyncerConfigClusterLister
}
	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.EdgeV2alpha1().SyncerConfigs().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EdgeV2alpha1().SyncerConfigs().Watch(context.TODO(), options)
			},
		},
		&edgev2alpha1.SyncerConfig{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *syncerConfigClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return f.factory.InformerFor(&edgev2alpha1.SyncerConfig{}, f.defaultInformer)
}

func (f *syncerConfigClusterInformer) Lister() edgev2alpha1listers.SyncerConfigClusterLister {
	return edgev2alpha1listers.NewSyncerConfigClusterLister(f.Informer().GetIndexer())
}
...
type SyncerConfigInformer interface {
	...
	Lister() edgev2alpha1listers.SyncerConfigLister
}
...
func (f *syncerConfigInformer) Lister() edgev2alpha1listers.SyncerConfigLister {
	return f.lister
}
...
func (f *syncerConfigScopedInformer) Lister() edgev2alpha1listers.SyncerConfigLister {
	return edgev2alpha1listers.NewSyncerConfigLister(f.Informer().GetIndexer())
}
