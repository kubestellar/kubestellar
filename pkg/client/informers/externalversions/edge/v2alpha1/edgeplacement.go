...
type EdgePlacementClusterInformer interface {
	...
	Lister() edgev2alpha1listers.EdgePlacementClusterLister
}
	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.EdgeV2alpha1().EdgePlacements().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EdgeV2alpha1().EdgePlacements().Watch(context.TODO(), options)
			},
		},
		&edgev2alpha1.EdgePlacement{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *edgePlacementClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return f.factory.InformerFor(&edgev2alpha1.EdgePlacement{}, f.defaultInformer)
}

func (f *edgePlacementClusterInformer) Lister() edgev2alpha1listers.EdgePlacementClusterLister {
	return edgev2alpha1listers.NewEdgePlacementClusterLister(f.Informer().GetIndexer())
}
...
type EdgePlacementInformer interface {
	...
	Lister() edgev2alpha1listers.EdgePlacementLister
}
...
func (f *edgePlacementInformer) Lister() edgev2alpha1listers.EdgePlacementLister {
	return f.lister
}
...
func (f *edgePlacementScopedInformer) Lister() edgev2alpha1listers.EdgePlacementLister {
	return edgev2alpha1listers.NewEdgePlacementLister(f.Informer().GetIndexer())
}
