...
type CustomizerClusterInformer interface {
	...
	Lister() edgev2alpha1listers.CustomizerClusterLister
}
	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.EdgeV2alpha1().Customizers().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EdgeV2alpha1().Customizers().Watch(context.TODO(), options)
			},
		},
		&edgev2alpha1.Customizer{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *customizerClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return f.factory.InformerFor(&edgev2alpha1.Customizer{}, f.defaultInformer)
}

func (f *customizerClusterInformer) Lister() edgev2alpha1listers.CustomizerClusterLister {
	return edgev2alpha1listers.NewCustomizerClusterLister(f.Informer().GetIndexer())
}
...
type CustomizerInformer interface {
	...
	Lister() edgev2alpha1listers.CustomizerLister
}
...
func (f *customizerInformer) Lister() edgev2alpha1listers.CustomizerLister {
	return f.lister
}
...
func (f *customizerScopedInformer) Lister() edgev2alpha1listers.CustomizerLister {
	return edgev2alpha1listers.NewCustomizerLister(f.Informer().GetIndexer())
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.EdgeV2alpha1().Customizers(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EdgeV2alpha1().Customizers(namespace).Watch(context.TODO(), options)
			},
		},
		&edgev2alpha1.Customizer{},
		resyncPeriod,
