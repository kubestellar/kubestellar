...
type SyncTargetClusterInformer interface {
	...
	Lister() edgev1alpha1listers.SyncTargetClusterLister
}
	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.EdgeV1alpha1().SyncTargets().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EdgeV1alpha1().SyncTargets().Watch(context.TODO(), options)
			},
		},
		&edgev1alpha1.SyncTarget{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *syncTargetClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return f.factory.InformerFor(&edgev1alpha1.SyncTarget{}, f.defaultInformer)
}

func (f *syncTargetClusterInformer) Lister() edgev1alpha1listers.SyncTargetClusterLister {
	return edgev1alpha1listers.NewSyncTargetClusterLister(f.Informer().GetIndexer())
}
...
type SyncTargetInformer interface {
	...
	Lister() edgev1alpha1listers.SyncTargetLister
}
...
func (f *syncTargetInformer) Lister() edgev1alpha1listers.SyncTargetLister {
	return f.lister
}
...
func (f *syncTargetScopedInformer) Lister() edgev1alpha1listers.SyncTargetLister {
	return edgev1alpha1listers.NewSyncTargetLister(f.Informer().GetIndexer())
}
