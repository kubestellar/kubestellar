...
type ClusterProviderDescClusterLister interface {
	...
	List(selector labels.Selector) (ret []*lcv1alpha1.ClusterProviderDesc, err error)
...
func (s *clusterProviderDescClusterLister) List(selector labels.Selector) (ret []*lcv1alpha1.ClusterProviderDesc, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*lcv1alpha1.ClusterProviderDesc))
	})
	return ret, err
}
...
type ClusterProviderDescLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*lcv1alpha1.ClusterProviderDesc, error)
...
func (s *clusterProviderDescLister) List(selector labels.Selector) (ret []*lcv1alpha1.ClusterProviderDesc, err error) {
	err = kcpcache.ListAllByCluster(s.indexer, s.clusterName, selector, func(i interface{}) {
		ret = append(ret, i.(*lcv1alpha1.ClusterProviderDesc))
	})
	return ret, err
}

// Get retrieves the ClusterProviderDesc from the indexer for a given workspace and name.
func (s *clusterProviderDescLister) Get(name string) (*lcv1alpha1.ClusterProviderDesc, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(lcv1alpha1.Resource("ClusterProviderDesc"), name)
	}
	return obj.(*lcv1alpha1.ClusterProviderDesc), nil
}
...
// List lists all ClusterProviderDescs in the indexer for a workspace.
func (s *clusterProviderDescScopedLister) List(selector labels.Selector) (ret []*lcv1alpha1.ClusterProviderDesc, err error) {
...
// Get retrieves the ClusterProviderDesc from the indexer for a given workspace and name.
func (s *clusterProviderDescScopedLister) Get(name string) (*lcv1alpha1.ClusterProviderDesc, error) {
	key := name
	obj, exists, err := s.indexer.GetByKey(key)
	if err != nil {
		return nil, err
