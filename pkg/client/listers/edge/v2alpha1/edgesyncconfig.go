...
type EdgeSyncConfigClusterLister interface {
	...
	List(selector labels.Selector) (ret []*edgev2alpha1.EdgeSyncConfig, err error)
...
func (s *edgeSyncConfigClusterLister) List(selector labels.Selector) (ret []*edgev2alpha1.EdgeSyncConfig, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*edgev2alpha1.EdgeSyncConfig))
	})
	return ret, err
}
...
type EdgeSyncConfigLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*edgev2alpha1.EdgeSyncConfig, error)
...
func (s *edgeSyncConfigLister) List(selector labels.Selector) (ret []*edgev2alpha1.EdgeSyncConfig, err error) {
	err = kcpcache.ListAllByCluster(s.indexer, s.clusterName, selector, func(i interface{}) {
		ret = append(ret, i.(*edgev2alpha1.EdgeSyncConfig))
	})
	return ret, err
}

// Get retrieves the EdgeSyncConfig from the indexer for a given workspace and name.
func (s *edgeSyncConfigLister) Get(name string) (*edgev2alpha1.EdgeSyncConfig, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(edgev2alpha1.Resource("EdgeSyncConfig"), name)
	}
	return obj.(*edgev2alpha1.EdgeSyncConfig), nil
}
...
// List lists all EdgeSyncConfigs in the indexer for a workspace.
func (s *edgeSyncConfigScopedLister) List(selector labels.Selector) (ret []*edgev2alpha1.EdgeSyncConfig, err error) {
...
// Get retrieves the EdgeSyncConfig from the indexer for a given workspace and name.
func (s *edgeSyncConfigScopedLister) Get(name string) (*edgev2alpha1.EdgeSyncConfig, error) {
	key := name
	obj, exists, err := s.indexer.GetByKey(key)
	if err != nil {
		return nil, err
