...
type EdgePlacementClusterLister interface {
	...
	List(selector labels.Selector) (ret []*edgev2alpha1.EdgePlacement, err error)
...
func (s *edgePlacementClusterLister) List(selector labels.Selector) (ret []*edgev2alpha1.EdgePlacement, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*edgev2alpha1.EdgePlacement))
	})
	return ret, err
}
...
type EdgePlacementLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*edgev2alpha1.EdgePlacement, error)
...
func (s *edgePlacementLister) List(selector labels.Selector) (ret []*edgev2alpha1.EdgePlacement, err error) {
	err = kcpcache.ListAllByCluster(s.indexer, s.clusterName, selector, func(i interface{}) {
		ret = append(ret, i.(*edgev2alpha1.EdgePlacement))
	})
	return ret, err
}

// Get retrieves the EdgePlacement from the indexer for a given workspace and name.
func (s *edgePlacementLister) Get(name string) (*edgev2alpha1.EdgePlacement, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(edgev2alpha1.Resource("EdgePlacement"), name)
	}
	return obj.(*edgev2alpha1.EdgePlacement), nil
}
...
// List lists all EdgePlacements in the indexer for a workspace.
func (s *edgePlacementScopedLister) List(selector labels.Selector) (ret []*edgev2alpha1.EdgePlacement, err error) {
...
// Get retrieves the EdgePlacement from the indexer for a given workspace and name.
func (s *edgePlacementScopedLister) Get(name string) (*edgev2alpha1.EdgePlacement, error) {
	key := name
	obj, exists, err := s.indexer.GetByKey(key)
	if err != nil {
		return nil, err
