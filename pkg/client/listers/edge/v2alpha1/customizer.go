...
type CustomizerClusterLister interface {
	...
	List(selector labels.Selector) (ret []*edgev2alpha1.Customizer, err error)
...
func (s *customizerClusterLister) List(selector labels.Selector) (ret []*edgev2alpha1.Customizer, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*edgev2alpha1.Customizer))
	})
	return ret, err
}
...
func (s *customizerLister) List(selector labels.Selector) (ret []*edgev2alpha1.Customizer, err error) {
	err = kcpcache.ListAllByCluster(s.indexer, s.clusterName, selector, func(i interface{}) {
		ret = append(ret, i.(*edgev2alpha1.Customizer))
	})
	return ret, err
}
...
type CustomizerNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*edgev2alpha1.Customizer, error)
...
func (s *customizerNamespaceLister) List(selector labels.Selector) (ret []*edgev2alpha1.Customizer, err error) {
...
// Get retrieves the Customizer from the indexer for a given workspace, namespace and name.
func (s *customizerNamespaceLister) Get(name string) (*edgev2alpha1.Customizer, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(edgev2alpha1.Resource("Customizer"), name)
	}
	return obj.(*edgev2alpha1.Customizer), nil
}
...
// List lists all Customizers in the indexer for a workspace.
func (s *customizerScopedLister) List(selector labels.Selector) (ret []*edgev2alpha1.Customizer, err error) {
...
// List lists all Customizers in the indexer for a given workspace and namespace.
func (s *customizerScopedNamespaceLister) List(selector labels.Selector) (ret []*edgev2alpha1.Customizer, err error) {
...
// Get retrieves the Customizer from the indexer for a given workspace, namespace and name.
func (s *customizerScopedNamespaceLister) Get(name string) (*edgev2alpha1.Customizer, error) {
