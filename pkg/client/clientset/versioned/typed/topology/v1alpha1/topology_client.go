...
// TopologyV1alpha1Client is used to interact with features provided by the topology group.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*TopologyV1alpha1Client, error) {
	...
	return &TopologyV1alpha1Client{restClient: client}, nil
}
...
func New(c rest.Interface) *TopologyV1alpha1Client {
	return &TopologyV1alpha1Client{restClient: c}
}

// NewWithCluster creates a new TopologyV1alpha1Client for the given RESTClient and cluster.
func NewWithCluster(c rest.Interface, cluster v2.Name) *TopologyV1alpha1Client {
	return &TopologyV1alpha1Client{restClient: c, cluster: cluster}
}
