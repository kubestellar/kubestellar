...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*CoreV1alpha1Client, error) {
	...
	return &CoreV1alpha1Client{restClient: client}, nil
}
...
// NewWithCluster creates a new CoreV1alpha1Client for the given RESTClient and cluster.
func NewWithCluster(c rest.Interface, cluster v2.Name) *CoreV1alpha1Client {
	return &CoreV1alpha1Client{restClient: c, cluster: cluster}
}
