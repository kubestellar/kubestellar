...
func newCustomizers(c *EdgeV1alpha1Client, namespace string) *customizers {
	return &customizers{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *customizers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Customizer, err error) {
	result = &v1alpha1.Customizer{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *customizers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CustomizerList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.CustomizerList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("customizers").
...
func (c *customizers) Create(ctx context.Context, customizer *v1alpha1.Customizer, opts v1.CreateOptions) (result *v1alpha1.Customizer, err error) {
	result = &v1alpha1.Customizer{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("customizers").
...
func (c *customizers) Update(ctx context.Context, customizer *v1alpha1.Customizer, opts v1.UpdateOptions) (result *v1alpha1.Customizer, err error) {
	result = &v1alpha1.Customizer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("customizers").
...
func (c *customizers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Customizer, err error) {
	result = &v1alpha1.Customizer{}
