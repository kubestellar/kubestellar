...
func (c *FakeEdgePlacements) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.EdgePlacement, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(edgeplacementsResource, name), &v1alpha1.EdgePlacement{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.EdgePlacement), err
}
...
func (c *FakeEdgePlacements) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EdgePlacementList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(edgeplacementsResource, edgeplacementsKind, opts), &v1alpha1.EdgePlacementList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &v1alpha1.EdgePlacementList{ListMeta: obj.(*v1alpha1.EdgePlacementList).ListMeta}
	for _, item := range obj.(*v1alpha1.EdgePlacementList).Items {
...
func (c *FakeEdgePlacements) Create(ctx context.Context, edgePlacement *v1alpha1.EdgePlacement, opts v1.CreateOptions) (result *v1alpha1.EdgePlacement, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(edgeplacementsResource, edgePlacement), &v1alpha1.EdgePlacement{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.EdgePlacement), err
...
func (c *FakeEdgePlacements) Update(ctx context.Context, edgePlacement *v1alpha1.EdgePlacement, opts v1.UpdateOptions) (result *v1alpha1.EdgePlacement, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(edgeplacementsResource, edgePlacement), &v1alpha1.EdgePlacement{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.EdgePlacement), err
...
func (c *FakeEdgePlacements) UpdateStatus(ctx context.Context, edgePlacement *v1alpha1.EdgePlacement, opts v1.UpdateOptions) (*v1alpha1.EdgePlacement, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(edgeplacementsResource, "status", edgePlacement), &v1alpha1.EdgePlacement{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.EdgePlacement), err
...
func (c *FakeEdgePlacements) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteActionWithOptions(edgeplacementsResource, name, opts), &v1alpha1.EdgePlacement{})
	return err
}
...
func (c *FakeEdgePlacements) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1alpha1.EdgePlacementList{})
	return err
}
...
func (c *FakeEdgePlacements) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.EdgePlacement, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(edgeplacementsResource, name, pt, data, subresources...), &v1alpha1.EdgePlacement{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.EdgePlacement), err
