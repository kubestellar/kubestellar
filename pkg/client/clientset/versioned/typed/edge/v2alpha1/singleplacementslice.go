...
type SinglePlacementSliceInterface interface {
	Create(ctx context.Context, singlePlacementSlice *v2alpha1.SinglePlacementSlice, opts v1.CreateOptions) (*v2alpha1.SinglePlacementSlice, error)
	Update(ctx context.Context, singlePlacementSlice *v2alpha1.SinglePlacementSlice, opts v1.UpdateOptions) (*v2alpha1.SinglePlacementSlice, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v2alpha1.SinglePlacementSlice, error)
	List(ctx context.Context, opts v1.ListOptions) (*v2alpha1.SinglePlacementSliceList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v2alpha1.SinglePlacementSlice, err error)
...
func newSinglePlacementSlices(c *EdgeV2alpha1Client) *singlePlacementSlices {
...
func (c *singlePlacementSlices) Get(ctx context.Context, name string, options v1.GetOptions) (result *v2alpha1.SinglePlacementSlice, err error) {
	result = &v2alpha1.SinglePlacementSlice{}
	err = c.client.Get().
...
func (c *singlePlacementSlices) List(ctx context.Context, opts v1.ListOptions) (result *v2alpha1.SinglePlacementSliceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v2alpha1.SinglePlacementSliceList{}
	err = c.client.Get().
		Resource("singleplacementslices").
...
func (c *singlePlacementSlices) Create(ctx context.Context, singlePlacementSlice *v2alpha1.SinglePlacementSlice, opts v1.CreateOptions) (result *v2alpha1.SinglePlacementSlice, err error) {
	result = &v2alpha1.SinglePlacementSlice{}
	err = c.client.Post().
		Resource("singleplacementslices").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *singlePlacementSlices) Update(ctx context.Context, singlePlacementSlice *v2alpha1.SinglePlacementSlice, opts v1.UpdateOptions) (result *v2alpha1.SinglePlacementSlice, err error) {
	result = &v2alpha1.SinglePlacementSlice{}
	err = c.client.Put().
		Resource("singleplacementslices").
...
func (c *singlePlacementSlices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v2alpha1.SinglePlacementSlice, err error) {
	result = &v2alpha1.SinglePlacementSlice{}
