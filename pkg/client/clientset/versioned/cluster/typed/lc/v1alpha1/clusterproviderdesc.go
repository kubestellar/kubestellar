...
// or scope down to one cluster and return a lcv1alpha1client.ClusterProviderDescInterface.
type ClusterProviderDescClusterInterface interface {
	Cluster(logicalcluster.Path) lcv1alpha1client.ClusterProviderDescInterface
	List(ctx context.Context, opts metav1.ListOptions) (*lcv1alpha1.ClusterProviderDescList, error)
	Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error)
}

type clusterProviderDescsClusterInterface struct {
	clientCache kcpclient.Cache[*lcv1alpha1client.LcV1alpha1Client]
}

// Cluster scopes the client down to a particular cluster.
func (c *clusterProviderDescsClusterInterface) Cluster(clusterPath logicalcluster.Path) lcv1alpha1client.ClusterProviderDescInterface {
...
func (c *clusterProviderDescsClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*lcv1alpha1.ClusterProviderDescList, error) {
