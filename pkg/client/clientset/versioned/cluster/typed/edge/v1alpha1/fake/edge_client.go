...
func (c *EdgeV1alpha1ClusterClient) ClusterProviderInfods() kcpedgev1alpha1.ClusterProviderInfodClusterInterface {
	return &clusterProviderInfodsClusterClient{Fake: c.Fake}
}
...
func (c *EdgeV1alpha1Client) ClusterProviderInfods() edgev1alpha1.ClusterProviderInfodInterface {
	return &clusterProviderInfodsClient{Fake: c.Fake, ClusterPath: c.ClusterPath}
}
