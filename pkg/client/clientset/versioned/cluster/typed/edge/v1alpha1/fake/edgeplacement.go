...
func (c *edgePlacementsClusterClient) List(ctx context.Context, opts metav1.ListOptions) (*edgev1alpha1.EdgePlacementList, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootListAction(edgePlacementsResource, edgePlacementsKind, logicalcluster.Wildcard, opts), &edgev1alpha1.EdgePlacementList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &edgev1alpha1.EdgePlacementList{ListMeta: obj.(*edgev1alpha1.EdgePlacementList).ListMeta}
	for _, item := range obj.(*edgev1alpha1.EdgePlacementList).Items {
...
func (c *edgePlacementsClient) Create(ctx context.Context, edgePlacement *edgev1alpha1.EdgePlacement, opts metav1.CreateOptions) (*edgev1alpha1.EdgePlacement, error) {
	...
	return obj.(*edgev1alpha1.EdgePlacement), err
}
