...
func (c *singlePlacementSlicesClusterClient) List(ctx context.Context, opts metav1.ListOptions) (*edgev1alpha1.SinglePlacementSliceList, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootListAction(singlePlacementSlicesResource, singlePlacementSlicesKind, logicalcluster.Wildcard, opts), &edgev1alpha1.SinglePlacementSliceList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &edgev1alpha1.SinglePlacementSliceList{ListMeta: obj.(*edgev1alpha1.SinglePlacementSliceList).ListMeta}
	for _, item := range obj.(*edgev1alpha1.SinglePlacementSliceList).Items {
...
func (c *singlePlacementSlicesClient) Create(ctx context.Context, singlePlacementSlice *edgev1alpha1.SinglePlacementSlice, opts metav1.CreateOptions) (*edgev1alpha1.SinglePlacementSlice, error) {
	...
	return obj.(*edgev1alpha1.SinglePlacementSlice), err
}
