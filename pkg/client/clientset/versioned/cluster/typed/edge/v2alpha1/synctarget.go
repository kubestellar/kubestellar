...
// or scope down to one cluster and return a edgev2alpha1client.SyncTargetInterface.
type SyncTargetClusterInterface interface {
	Cluster(logicalcluster.Path) edgev2alpha1client.SyncTargetInterface
	List(ctx context.Context, opts metav1.ListOptions) (*edgev2alpha1.SyncTargetList, error)
...
func (c *syncTargetsClusterInterface) Cluster(clusterPath logicalcluster.Path) edgev2alpha1client.SyncTargetInterface {
...
func (c *syncTargetsClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*edgev2alpha1.SyncTargetList, error) {
