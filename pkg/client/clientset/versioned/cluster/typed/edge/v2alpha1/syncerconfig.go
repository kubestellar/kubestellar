...
// or scope down to one cluster and return a edgev2alpha1client.SyncerConfigInterface.
type SyncerConfigClusterInterface interface {
	Cluster(logicalcluster.Path) edgev2alpha1client.SyncerConfigInterface
	List(ctx context.Context, opts metav1.ListOptions) (*edgev2alpha1.SyncerConfigList, error)
...
func (c *syncerConfigsClusterInterface) Cluster(clusterPath logicalcluster.Path) edgev2alpha1client.SyncerConfigInterface {
...
func (c *syncerConfigsClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*edgev2alpha1.SyncerConfigList, error) {
