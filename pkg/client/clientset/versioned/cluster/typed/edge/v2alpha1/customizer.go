...
type CustomizerClusterInterface interface {
	...
	List(ctx context.Context, opts metav1.ListOptions) (*edgev2alpha1.CustomizerList, error)
...
func (c *customizersClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*edgev2alpha1.CustomizerList, error) {
...
// CustomizersNamespacer can scope to objects within a namespace, returning a edgev2alpha1client.CustomizerInterface.
type CustomizersNamespacer interface {
	Namespace(string) edgev2alpha1client.CustomizerInterface
}
