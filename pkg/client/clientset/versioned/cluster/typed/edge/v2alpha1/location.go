...
// or scope down to one cluster and return a edgev2alpha1client.LocationInterface.
type LocationClusterInterface interface {
	Cluster(logicalcluster.Path) edgev2alpha1client.LocationInterface
	List(ctx context.Context, opts metav1.ListOptions) (*edgev2alpha1.LocationList, error)
...
func (c *locationsClusterInterface) Cluster(clusterPath logicalcluster.Path) edgev2alpha1client.LocationInterface {
...
func (c *locationsClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*edgev2alpha1.LocationList, error) {
