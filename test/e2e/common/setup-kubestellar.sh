...
kubectl --context $HOSTING_CONTEXT wait -n its1-system job.batch/update-cluster-info --for condition=Complete --timeout 200s
...
test/e2e/run-test.sh --test-type ginkgo
