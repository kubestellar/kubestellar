...
# Purpose: to ensure that the required packages need to experiment with kcp-dge are installed

# Assumption: supported OS Platforms Linux, MacOs or Windows WSL/Ubuntu

# This will check if a package is already installed
