...
require (
	...
	github.com/kcp-dev/contrib-tmc v0.20.0
...
// replace directive is aligned with kcp v0.20.0 (https://github.com/kcp-dev/kcp/blob/v0.20.0/go.mod)
replace (
	github.com/google/cel-go => github.com/google/cel-go v0.12.6
	github.com/kcp-dev/kcp/sdk => github.com/kcp-dev/kcp/sdk v0.20.0
