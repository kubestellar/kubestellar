...
func (in *ClusterScopeDownsyncClause) DeepCopyInto(out *ClusterScopeDownsyncClause) {
	*out = *in
	...
	in.DownsyncModulation.DeepCopyInto(&out.DownsyncModulation)
}
...
func (in *NamedStatusCombination) DeepCopyInto(out *NamedStatusCombination) {
	*out = *in
	...
	if in.RowErrors != nil {
		in, out := &in.RowErrors, &out.RowErrors
		*out = make([]RowEvaluationError, len(*in))
		copy(*out, *in)
	}
	if in.AggregationErrors != nil {
		in, out := &in.AggregationErrors, &out.AggregationErrors
		*out = make([]ErrorInColumn, len(*in))
		copy(*out, *in)
	}
}
