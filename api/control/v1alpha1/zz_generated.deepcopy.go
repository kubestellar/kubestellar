...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PropagatationData) DeepCopyInto(out *PropagatationData) {
	*out = *in
	in.LastReturnedUpdateTimestamp.DeepCopyInto(&out.LastReturnedUpdateTimestamp)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PropagatationData.
func (in *PropagatationData) DeepCopy() *PropagatationData {
	if in == nil {
		return nil
	}
	out := new(PropagatationData)
	in.DeepCopyInto(out)
	return out
}
