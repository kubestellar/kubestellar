...
import (
	...
	"github.com/kubestellar/kubestellar/space-framework/pkg/client/clientset/versioned/scheme"
)

type SpaceV1alpha1Interface interface {
	RESTClient() rest.Interface
	SpacesGetter
	SpaceProviderDescsGetter
}

// SpaceV1alpha1Client is used to interact with features provided by the space.kubestellar.io group.
...
func (c *SpaceV1alpha1Client) SpaceProviderDescs() SpaceProviderDescInterface {
	return newSpaceProviderDescs(c)
}
